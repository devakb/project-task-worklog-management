...
class TaskExporter extends Exporter
{
    ...
    public static function getColumns(): array
    {
        return [
            ...
            ExportColumn::make('created_by_user_id'),
            ExportColumn::make('parent_task_id'),
            ExportColumn::make('task_key'),
            ExportColumn::make('task_code'),
            ExportColumn::make('title'),
            ExportColumn::make('description'),
            ExportColumn::make('task_type'),
            ExportColumn::make('task_status'),
            ExportColumn::make('task_priority'),
